...
from app.schemas.demo_room import DemoRoomNicknameRequest, DemoRoomStartRequest
...
class DemoRoomsApiTest(unittest.TestCase):
    ...
    def test_two_players_can_start_and_room_status_is_shared(self):
        created = demo_rooms.create_demo_room(DemoRoomNicknameRequest(nickname='방장'), self.store)
    ...
    def test_host_cannot_start_alone(self):
        created = demo_rooms.create_demo_room(DemoRoomNicknameRequest(nickname='혼자'), self.store)
    ...
    def test_room_rejects_the_eleventh_player(self):
        demo_rooms.create_demo_room(DemoRoomNicknameRequest(nickname='방장'), self.store)
    ...
    def test_host_game_selection_is_shared_as_a_guide_for_every_participant(self):
        created = demo_rooms.create_demo_room(DemoRoomNicknameRequest(nickname='host'), self.store)
