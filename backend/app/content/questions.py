...
EITHER_OR_QUESTIONS = [
    ...
    {"question_no": 3, "situation": "단톡방에 할 말이 생겼다", "a": "생각나면 바로 쓴다", "b": "정리해서 한 번에 쓴다", "ability": "EXP"},
    {"question_no": 4, "situation": "발표자를 정한다", "a": "내가 한다", "b": "남이 하면 좋겠다", "ability": "EXP"},
    {"question_no": 5, "situation": "아이디어가 떠올랐다", "a": "다듬기 전에 던진다", "b": "확신이 들 때만 꺼낸다", "ability": "EXP"},
    {"question_no": 6, "situation": "팀원이 마감을 놓쳤다", "a": "무슨 일 있냐고 먼저 묻는다", "b": "언제까지 되냐고 먼저 묻는다", "ability": "EMP"},
    {"question_no": 7, "situation": "의견이 갈렸다", "a": "소수 의견을 한 번 더 듣는다", "b": "다수로 빨리 정한다", "ability": "EMP"},
    {"question_no": 8, "situation": "방향이 틀린 것 같다", "a": "지금 말한다", "b": "일단 해보고 말한다", "ability": "EMP"},
]

# §6 — 주도력은 눈치 게임이 절반을 받쳐주므로 문항을 둘로 줄이고, 대신 문항
# 하나뿐이던 공감력을 셋으로 늘렸다. 값이 0/2.5/5 세 단계밖에 안 나오던 문제.
DOM_QUESTIONS = (1, 2)
EXP_QUESTIONS = (3, 4, 5)
EMP_QUESTIONS = (6, 7, 8)
